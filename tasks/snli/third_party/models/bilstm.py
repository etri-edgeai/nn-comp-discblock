...
class BiLSTM(nn.Module):
        def __init__(self, options):
                ...
                self.num_layers = 2
                self.concat = 4
                self.device = options["device"] # not used
        ...
        def forward(self, batch):
                ...
                h0 = c0 = torch.tensor([]).new_zeros((self.num_layers * self.directions, batch.batch_size, self.hidden_size)).to(self.lin1.weight.device)
